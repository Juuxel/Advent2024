...
public final class AdventGui {
    ...
    private static final Solution[] SOLUTIONS = {
        ...
        new Solution("Day 4 (part 1, Java)", 4, lines(Day4::part1)),
        new Solution("Day 4 (part 2, Java)", 4, lines(Day4::part2)),
        new Solution("Day 5 (part 1, Java)", 5, lines(Day5::part1)),
        new Solution("Day 5 (part 2, Java)", 5, lines(Day5::part2)),
        new Solution("Day 6 (Java)", 6, lines(Day6::run)),
        new Solution("Day 7 (part 1, Java)", 7, lines(Day7::part1)),
        new Solution("Day 7 (part 2, Java)", 7, lines(Day7::part2)),
        new Solution("Day 8 (part 1, Java)", 8, lines(Day8::part1)),
        ...
        new Solution("Day 11 (Java)", 11, lines(Day11::run)),
        new Solution("Day 12 (Java)", 12, lines(Day12::run)),
        new Solution("Day 13 (Java)", 13, lines(Day13::run)),
        new Solution("Day 14, part 1 (Java)", 14, lines(Day14::part1)),
        new Solution("Day 14, part 2 (Java)", 14, lines(lines -> Day14.part2(lines, false))),
        new Solution("Day 15 (part 1, Java)", 15, lines(Day15::part1)),
        new Solution("Day 15 (part 2, Java)", 15, lines(Day15::part2)),
        new Solution("Day 16 (Java)", 16, lines(Day16::run)),
    };
